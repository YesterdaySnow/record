...
//前台订货查询
  public List selectOrderHead(String name) {
     ...
     while (rs.next()) {
       ...
       System.out.println("---------------start-next9---------------");
       
       order.setBz(rs.getString(9));
       System.out.println("---------------start-next10---------------");
       order.setSign(rs.getInt(10));
       System.out.println("---------------start-next11---------------");
       order.setCreaTime(rs.getString(11));
       System.out.println("---------------start-next12---------------");
       list.add(order);
       System.out.println("---------------start-next13---------------");
