...
public class GoodsAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		case 17: {
			return goodSelectSearchHead(mapping, form, request, response); // 新品查询
		}
		case 18: {
			return goodPicture(mapping, form,request,response);
		}
		}
	...
	//搜索
	public ActionForward goodSelectSearchHead(ActionMapping mapping,
			ActionForm form, HttpServletRequest request,
			HttpServletResponse response) {
		List list = null;
		...
		request.setAttribute("list", list);
		return mapping.findForward("goodSelectSearchHead");
	}
	...
	//点击图片跳转
	public ActionForward goodPicture(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response)
	{
		GoodsForm goodsForm = (GoodsForm)dao.selectOneGoods(Integer.valueOf(request.getParameter("id")));
		request.setAttribute("goodPicture",goodsForm);
		return mapping.findForward("goodPicture");
	}
}
