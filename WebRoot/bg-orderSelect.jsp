   ...
   <td width="29%"><div align="center">操作</div></td>
      ...
      OrderForm form=(OrderForm)list.get(i);
        ...
        <tr align="center" bgcolor="#FFFFFF">
		  ...
		  <td><%if(form.getSign()==0){%>
                    <a href="orderAction.do?action=0&sign=<%=String.valueOf(form.getSign())%>">否</a>
                    <%}else{%>
                    <a href="orderAction.do?action=0&sign=<%=String.valueOf(form.getSign())%>">是</a>
          <%}%></td>
