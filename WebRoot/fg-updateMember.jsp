...
if(document.memberForm.passwordOld.value!=document.memberForm.oldPassword.value){
alert("原密码错误");
return false;
}
...
<% String a="memberAction.do?action=6&id="+form.getId();%>
<html:form action="<%=a%>"  onsubmit="return checkEmpty(memberForm)">
