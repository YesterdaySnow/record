...
<table width="766" height="82" border="0" align="center" cellpadding="0" cellspacing="0" background="image/fg_top02.jpg">
  <tr>
    <td>&nbsp;</td>
  </tr>
</table>
<table width="766" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#819BBC" background="image/fg_top03.jpg">
      <tr align="center">
        ...
        <td width="117" onMouseOver="this.style.backgroundImage='url(image/fg_top04.jpg)'" onMouseOut="this.style.backgroundImage=''"><a href="goodsAction.do?action=17" class="a4">搜索商品</a></td>
      </tr>	
</table>
<table width="766" height="240" border="0" align="center">
	<tr>
		<td>
			<div id="imageFlow">
				<div class="top"></div>
				...
				<%
		              ...
		              for(int i=0;i<now;i++)
		              {
		                ...
		                %>
					<a rel="<%=newGoods.getPriture() %>" title="<%=newGoods.getName() %>" href="goodsAction.do?action=18&id=<%=newGoods.getId() %>" ><%=newGoods.getIntroduce() %></a>
				<%} %>
				</div>
				...
				<div class="scrollbar">
					<img class="track" src="image/sb.gif" alt="">
					<img class="arrow-left" src="image/sl.gif" alt="">
					<img class="arrow-right" src="image/sr.gif" alt="">
					<img class="bar" src="image/sc.gif" alt="">
				</div>
			</div>
		</td>
	</tr>
