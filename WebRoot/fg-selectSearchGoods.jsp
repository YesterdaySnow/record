...
<table width="766" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	<table width="546" height="42" border="0" align="center" cellpadding="0" cellspacing="0" background="image/fg_right05.jpg">
  <tr>
    <td>&nbsp;	</td>
    </tr>
...
<table width="546" height="42" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <br>
        <center>   <form name="form" method="post" action="goodsAction.do?action=17">
           
          搜索商品名称： <input type="text" name="search" value=""/>&nbsp;
			 ...
			 <br> <table width="99%" height="100"  border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#819BBC">
              ...
              <tr>
               ...
               <a href="#" onClick="window.open('goodsAction.do?action=16&id=<%=newGoods.getId()%>','','width=500,height=200');">查看</a></div>
